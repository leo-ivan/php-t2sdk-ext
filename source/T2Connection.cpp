...
zval* T2Connection::req333100(char sort_direction, char *position_str, int request_num)
{
    IBizMessage* lpBizMessage = T2NewBizMessage();
    lpBizMessage->AddRef();
    ...
    IBizMessage* lpBizMessageRecv = NULL;
        ...
        //功能号
    lpBizMessage->SetFunction(333100);
        //请求类型
    lpBizMessage->SetPacketType(REQUEST_PACKET);
        //设置营业部号
    lpBizMessage->SetBranchNo(1);
...
zval* T2Connection::req339303(int start_date, int end_date, char *position_str, int request_num)
{
    IBizMessage* lpBizMessage = T2NewBizMessage();
    lpBizMessage->AddRef();
    ...
    IBizMessage* lpBizMessageRecv = NULL;
        ...
        //功能号
    lpBizMessage->SetFunction(339303);
        //请求类型
    lpBizMessage->SetPacketType(REQUEST_PACKET);
        //设置营业部号
    lpBizMessage->SetBranchNo(1);
...
zval* T2Connection::req339304(int start_date, int end_date, char *position_str, int request_num)
{
    ...
    IBizMessage* lpBizMessageRecv = NULL;
        ...
        //功能号
    lpBizMessage->SetFunction(339304);
        //请求类型
    lpBizMessage->SetPacketType(REQUEST_PACKET);
        //设置营业部号
    lpBizMessage->SetBranchNo(1);
...
zval* T2Connection::req333142(int entrust_no, int entrust_date, char *exchange_type)
{
    IBizMessage* lpBizMessage = T2NewBizMessage();
    lpBizMessage->AddRef();
    ...
    //pPacker->AddField("exchange_type", 'S', 4);
    pPacker->AddField("exchange_type", 'S', 4);
    pPacker->AddField("entrust_date", 'I', 8);
    pPacker->AddField("entrust_no", 'I', 8);
...
zval* T2Connection::req332253(char *bank_no, char *fund_password, char *bank_password)
{
    ...
    IBizMessage* lpBizMessageRecv = NULL;
        ...
        //功能号
    lpBizMessage->SetFunction(332253);
        //请求类型
    lpBizMessage->SetPacketType(REQUEST_PACKET);
        //设置营业部号
    // lpBizMessage->SetBranchNo(1);
...
zval* T2Connection::req331157()
{
    ...
    //功能号
    lpBizMessage->SetFunction(331157);
        //请求类型
    lpBizMessage->SetPacketType(REQUEST_PACKET);
        //设置营业部号
    // lpBizMessage->SetBranchNo(1);
...
zval* T2Connection::req339200(int begin_date, int end_date, char *position_str, int request_num)
{
    ...
    //功能号
    lpBizMessage->SetFunction(339200);
        //请求类型
    lpBizMessage->SetPacketType(REQUEST_PACKET);
        //设置营业部号
    // lpBizMessage->SetBranchNo(1);
...
zval* T2Connection::req339204(int start_date, int end_date, char *bank_no, int action_in, char *position_str, int request_num)
{
    IBizMessage* lpBizMessage = T2NewBizMessage();
    lpBizMessage->AddRef();
    ...
    //功能号
    lpBizMessage->SetFunction(339204);
        //请求类型
    lpBizMessage->SetPacketType(REQUEST_PACKET);
        //设置营业部号
    // lpBizMessage->SetBranchNo(1);
...
zval* T2Connection::req339300(int start_date, int end_date, char *position_str, int request_num)
{
    IBizMessage* lpBizMessage = T2NewBizMessage();
    lpBizMessage->AddRef();
    ...
    //功能号
    lpBizMessage->SetFunction(339300);
        //请求类型
    lpBizMessage->SetPacketType(REQUEST_PACKET);
        //设置营业部号
    // lpBizMessage->SetBranchNo(1);
    ...
    pPacker->AddField("start_date", 'I', 8);
    pPacker->AddField("end_date", 'I', 8);
    pPacker->AddField("deliver_type", 'C', 1);
    pPacker->AddField("exchange_type", 'S', 4);
